...
<table width="100%" border="0" class="tablebotones">
	<tr align="center">
		<form>
			<td align="center" >
						<a href="bclientes.php"><input type="button" name="btnBuscar" value="NUEVA BUSQUEDA" class="botonA"></a>
					</td>
		
		<td >
			<a href="consultaclientes.php"><input type="button" name="btnRetornar" value="CANCELAR" class="botonA"></a>
		</td>
		</form>
	</tr>
</table>
